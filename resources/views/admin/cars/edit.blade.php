                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="name"
                                    ...
                                    <option value="{{ $brand->name }}" {{$brand->name == $car->name ?
                                        'selected':''}}>{{ $brand->name }} - {{$car->number}}</option>
                                    @endforeach
                                </select>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="color"
                                    class="form-control @error('color') is-invalid @enderror" value="{{ $car->color }}">
                                @error('color')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="fuel"
                                    ...
                                    <option value="bensin" {{$car->fuel == 'bensin' ?
                                        'selected':''}}>Bensin</option>
                                    <option value="diesel" {{$car->fuel == 'diesel' ?
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="transmision"
                                    ...
                                    <option value="">--Select Transmision--</option>
                                    <option value="automatic" {{$car->transmision == 'automatic' ?
                                        'selected':''}}>automatic</option>
                                    <option value="manual" {{$car->transmision == 'manual' ?
